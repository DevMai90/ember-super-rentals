...
// Importing into integration test is different from component usage.
...
module('Integration | Component | share-button', function(hooks) {
  ...
  hooks.beforeEach(function() {
    // Registering the service router with this mock that we made.
    // Will call this mock router service in the tests instead of the real one.
